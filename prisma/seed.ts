...
async function main() {
  console.log("🌱 Gerçek yabancı & global dövme ustalarının profilleri yükleniyor...");
  ...
  // 2. Gerçek / Dünyaca Ünlü İkonik Sanatçı Profilleri
  const realArtists = [
    {
      email: "dr.woo@inkconnect.com",
      name: "Brian Woo (Dr. Woo)",
      avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop&crop=face",
      bio: "Los Angeles merkezli, 'Single Needle' (Tek İğne) ve ultra-ince detaylı mikro-realizm akımının dünyadaki öncüsü. Dünyaca ünlü aktör ve sanatçıların vazgeçilmez dövmecisi.",
      ...
      reviews: [
        { author: "Zoe Kravitz", rating: 5, comment: "Tek kelimeyle bir dahi. İğnenin teninize dokunduğunu bile hissetmiyorsunuz." },
        { author: "Justin Bieber", rating: 5, comment: "Dünyanın en iyi tek iğne sanatçısı. Detaylar inanılmaz." }
      ]
    },
    {
    ...
    },
    {
      ...
      bio: "High Voltage Tattoo kurucusu, Black & Grey portre ve gotik ince işçilik ustası. Dövme kültürünü dünya çapında ana akım haline getiren ikonik figür.",
      studioName: "High Voltage Tattoo",
      city: "Los Angeles / Beşiktaş",
      district: "Beşiktaş",
      experienceYears: 22,
      minPrice: 4000,
      maxPrice: 38000,
      ...
      reviews: [
        { author: "Lady Gaga", rating: 5, comment: "Ruhumu ve karakterimi birebir tenime aktardı. Muhteşem bir enerji." }
      ]
    },
    {
      ...
      bio: "Çağdaş suluboya (Watercolor) ve geometrik renk geçişlerinin öncüsü. Kontürsüz, yağlı boya tablo estetiğindeki dövme tasarımlarıyla uluslararası ödüllü sanatçı.",
      ...
      reviews: [
        { author: "Chiara Ferragni", rating: 5, comment: "Tenimde canlı bir tablo taşıyorum. Renklerin uyumu büyüleyici." }
      ]
    },
    {
    ...
    },
    {
      ...
      bio: "Yokohama merkezli, geleneksel Japon İrezumi sanatını 3 boyutlu dinamizm ve fütüristik renk patlamalarıyla modernize eden dünya şampiyonu usta.",
      ...
      reviews: [
        { author: "Kenji Sato", rating: 5, comment: "Geleneksel Japon sanatının yaşayan en büyük zirvesi. Saygıyla eğiliyorum." }
      ]
    }
  ];

  const defaultPassword = await hash("inkconnect123", 12);
